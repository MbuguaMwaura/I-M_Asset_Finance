...
public class BusinessCreditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String inputName = mSharedPreferences.getString(Constants.EIGHT_BUSINESS_NAME, null);
        String inputFacilityType = mSharedPreferences.getString(Constants.EIGHT_BUSINESS_FACILITY_TYPE, null);
        String inputSanctionedLimit = mSharedPreferences.getString(Constants.EIGHT_BUSINESS_SANCTIONED_LIMIT, null);
        String inputOutstanding= mSharedPreferences.getString(Constants.EIGHT_BUSINESS_CURRENT_OUTSTANDING, null);
    ...
    public void onClick(View v) {
        ...
        if (v == proceedEightBtn){
            ...
            Intent intent = new Intent(this, BusinessAttachmentActivity.class);
    ...
    private void addToSharedPreferences(String inputName,
        ...
        mEditor.putString(Constants.EIGHT_BUSINESS_NAME,inputName).apply();
        mEditor.putString(Constants.EIGHT_BUSINESS_FACILITY_TYPE,inputFacilitytype).apply();
        mEditor.putString(Constants.EIGHT_BUSINESS_SANCTIONED_LIMIT, inputSanctionedLimit).apply();
        mEditor.putString(Constants.EIGHT_BUSINESS_CURRENT_OUTSTANDING, inputOutstanding).apply();
