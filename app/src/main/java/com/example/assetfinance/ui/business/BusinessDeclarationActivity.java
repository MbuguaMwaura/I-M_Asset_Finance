...
public class BusinessDeclarationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    View view;
    BusinessDeclarationActivity.signature mSignature;
    Bitmap bitmap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Dialog Function
        dialog = new Dialog(BusinessDeclarationActivity.this);
...
//        sign.setOnClickListener(this);
    ...
    public void dialog_action(){
        ...
        mSignature = new BusinessDeclarationActivity.signature(getApplicationContext(),null);
    ...
    public void onClick(View v) {
        if (v == proceedTenBtn){
            ...
            if ((signature.equals(""))) {
                ...
                Intent intent = new Intent(this, BusinessPreviewActivity.class);
    ...
    private void uploadFile(Uri pdfUri) {
        progressDialog = new ProgressDialog(BusinessDeclarationActivity.this);
                ...
                reference.child("uploads").child(fileName).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(BusinessDeclarationActivity.this,"File successfully uploaded", Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
                        }else{
                            Toast.makeText(BusinessDeclarationActivity.this,"File not successfully uploaded", Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
                        }
                    }
                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 100 && resultCode == RESULT_OK && data != null) {
            ...
            addToSharedPreferences("signaturebusiness",signature);
